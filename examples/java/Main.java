...
public class Main {
    ...
    private static final String MARKET = "PK";
    private static final String EXCHANGE = "PSX";
    private static final String SYMBOL = "PSX:000040";
                ...
                .buildAsync(URI.create(WS_URL), new WebSocket.Listener() {
                    ...
                    public void onOpen(WebSocket webSocket) {
                        String subscribeJson = "{\"action\":\"subscribe\",\"market\":\"" + MARKET
                                + "\",\"exchange\":\"" + EXCHANGE
                                + "\",\"symbols\":[\"PSX:000040\",\"PSX:005930\"],\"replay\":\"last\"}";
